...
export function Task({
  ...
  }, [isRemoving, task.id, onRemovalComplete, checkboxScale, taskTranslateX, taskOpacity]);
            ...
            <View className="flex-row justify-between items-start">
              <View className="flex-row items-center flex-1">
                <Ionicons
                  ...
                  size={18}
                  color={isOverdue && !isCompleted ? "#ef4444" : getTaskColor(task.task_type)}
                  style={{ marginRight: 6 }}
                />
                ...
                <View style={{ position: "relative", flex: 1 }}>
                  <Animated.Text
                    className={`text-base font-paragraph font-medium ${
                      isOverdue && !isCompleted ? "text-red-700" : "text-foreground"
                    }`}
              ...
              >
                ...
                >
                  {isOverdue && !isCompleted ? "Overdue" : getRelativeTime(dueDate)}
                </Text>
              </View>
            </View>
