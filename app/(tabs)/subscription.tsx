...
} from "@/lib/subscriptionMutations";
					...
					<View className="bg-cream-50 border border-cream-200 rounded-xl p-6">
						...
						<View className="mb-4">
							...
							<BodyText className="text-muted-foreground text-sm mt-1">
								Full access to all GreenThumb features
							</BodyText>
						</View>
						...
						<View className="space-y-3">
							<View className="flex-row justify-between items-center">
								...
								<BodyText className="text-foreground font-medium">
									{subscription.subscription_plan_id === "monthly_premium" &&
										"$9.99 per month"}
									{subscription.subscription_plan_id === "six_month_premium" &&
										"$49.99 per 6 months"}
									{subscription.subscription_plan_id === "annual_premium" &&
										"$79.99 per year"}
									{![
										"monthly_premium",
										"six_month_premium",
										"annual_premium",
									].includes(subscription.subscription_plan_id || "") && "N/A"}
								</BodyText>
							</View>
