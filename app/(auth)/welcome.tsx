...
export default function WelcomeScreen() {
	...
	useEffect(() => {
		...
		console.log(
			"🔍 Welcome Screen: Setting component as mounted to prevent rapid unmounting"
		);
		...
		// Ensure component stays visible for at least 1 second
		return () => {
			console.log("📱 Welcome Screen: Component unmounting");
		};
	}, []);
	...
	// Don't render until component is fully mounted to prevent flashing
